...
\begin{figure}[]
		\centering
		  \subfigure[Setup 1]{
		   \includegraphics[width=0.3\textwidth]{figures/Experiment1_Setup.png} 
		   \label{fig:Exp1-Setup}
          }
          \subfigure[Path 1]{
	       \includegraphics[width=0.3\textwidth]{figures/Experiment1_Path1.png} 	
	       \label{fig:Exp1-Path1}
          } \\
		  \subfigure[Path 2]{
		   \includegraphics[width=0.3\textwidth]{figures/Experiment1_Path2.png} 
		   \label{fig:Exp1-Path2}
          }          
          \subfigure[Path 3]{
	       \includegraphics[width=0.3\textwidth]{figures/Experiment1_Path3.png} 	
	       \label{fig:Exp1-Path3}
          }
\caption{Experiment 1 with $\alpha = 0.5$. The path in Fig.\ref{fig:Exp1-Path1} is the shortest one. Path \ref{fig:Exp1-Path2} and \ref{fig:Exp1-Path3} are the next found }
\end{figure}
...
\begin{figure}[]
		\centering
		  \subfigure[Setup 2]{
		   \includegraphics[width=0.3\textwidth]{figures/Experiment2_Setup.png} 
		   \label{fig:Exp2-Setup}
          }
          \subfigure[Path 1]{
	       \includegraphics[width=0.3\textwidth]{figures/Experiment2_Path1.png} 	
	       \label{fig:Exp2-Path1}
          } \\
		  \subfigure[Path 2]{
		   \includegraphics[width=0.3\textwidth]{figures/Experiment2_Path2.png} 
		   \label{fig:Exp2-Path2}
          }          
          \subfigure[Path 3]{
	       \includegraphics[width=0.3\textwidth]{figures/Experiment2_Path3.png} 	
	       \label{fig:Exp2-Path3}
          }
          \subfigure[Path 4]{
	       \includegraphics[width=0.3\textwidth]{figures/Experiment2_Path4.png} 	
	       \label{fig:Exp2-Path4}
          }
\caption{Experiment 2 with $\alpha = 0.01$ }
\end{figure}
...
\begin{figure}[]
		\centering
		  \subfigure[Setup 3]{
		   \includegraphics[width=0.4\textwidth]{figures/Experiment3_Setup.png} 
		   \label{fig:Exp3-Setup}
          }\\
		  \subfigure[Path 1]{
		   \includegraphics[width=0.4\textwidth]{figures/Experiment3_Path1.png} 
		   \label{fig:Exp3-Path1}
          }          
          \subfigure[Path 2]{
	       \includegraphics[width=0.4\textwidth]{figures/Experiment3_Path2.png} 	
	       \label{fig:Exp3-Path2}
          }
\caption{Experiment 3 with $\alpha = 0.01$ }
\end{figure}
...
\begin{figure}[]
		\centering
		  \subfigure[Setup 4]{
		   \includegraphics[width=0.2\textwidth]{figures/Experiment4_Setup.png} 
		   \label{fig:Exp4-Setup}
          }
		  \subfigure[Path 1]{
		   \includegraphics[width=0.33\textwidth]{figures/Experiment4_Path1.png} 
		   \label{fig:Exp4-Path1}
          }          
          \subfigure[Path 2]{
	       \includegraphics[width=0.33\textwidth]{figures/Experiment4_Path2.png} 	
	       \label{fig:Exp4-Path2}
          }
\caption{Experiment 4 with $\alpha = 0.01$ }
\end{figure}
